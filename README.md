...
Repos นี้ถูกสร้างขึ้นโดยมีจุดหมายเพื่อช่วยให้นักพัฒนาเข้าใจในคอนเซปต์ของ Javascript. ไม่ได้เป็นข้อกำหนดตายตัว, แต่เพื่อเป็นแนวทางในการศึกษาทำความเข้าใจ. โดยอิงตามบทความของคุณ [Stephen Curtis](https://twitter.com/stephenthecurt) ซึ่งสามารถอ่านบทความต้นฉบับได้ที่นี่ [here](https://medium.com/@stephenthecurt/33-fundamentals-every-javascript-developer-should-know-13dd720a90d1).

**🚀 เป็นโปรเจคที่แนะนำสำหรับนักพัฒนาหน้าใหม่ [top open source projects of 2018!](https://blog.github.com/2018-12-13-new-open-source-projects/)**
...
ในส่วนของ Repos ภาษาไทยนี้ ผมจะทำการอัพเดทรวบรวมลิงค์คำอธิบายในหัวข้อต่าง ๆ จากแหล่งที่เป็นภาษาไทย เข้ามาเพิ่มเติมให้เรื่อย ๆ หรือหากใครต้องการเข้ามาช่วย PR อัพเดทก็ยินดีครับ.
...
## <a id="table-of-contents">สารบัญ</a>
...
- 📜 [รู้ลึกการทำงานแบบ Asynchronous กับ Event Loop — Nuttavut Thongjor](https://www.babelcoder.com/blog/articles/asynchronous-javascript-and-event-loop)
